      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {services.map((service, idx) => (
            <div 
              key={idx} 
              className="bg-white p-6 sm:p-10 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group cursor-default flex flex-col sm:flex-row gap-4 sm:gap-6 items-start"
            >
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gray-50 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:bg-primary group-hover:text-white transition-colors text-secondary">
                {service.icon}
              </div>
              <div>
        ...
        <div className="mt-12 sm:mt-20 text-center">
          <a
            href="#contact"
            className="inline-flex items-center justify-center px-8 sm:px-10 py-4 border border-transparent text-base sm:text-lg font-bold rounded-md text-white bg-primary hover:bg-orange-600 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1"
          >
            Free consultation
          </a>
        </div>

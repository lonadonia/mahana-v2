...
import { Languages, Fingerprint, Umbrella } from 'lucide-react';
import FadeIn from './animations/FadeIn';

const ProblemSection: React.FC = () => {
  const problems = [
    {
      icon: <Languages className="w-8 h-8 sm:w-10 sm:h-10" strokeWidth={1.2} />,
    ...
    {
      icon: <Fingerprint className="w-8 h-8 sm:w-10 sm:h-10" strokeWidth={1.2} />,
    ...
    {
      icon: <Umbrella className="w-8 h-8 sm:w-10 sm:h-10" strokeWidth={1.2} />,
        ...
        <div className="text-center max-w-4xl mx-auto mb-16 sm:mb-20">
          <FadeIn>
            <div className="inline-flex items-center justify-center mb-4">
              ...
              <span className="text-primary font-bold tracking-wider uppercase text-sm">The Challenge</span>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-sans font-bold text-secondary mb-4 sm:mb-6 tracking-tight">
              Why Most Foreign Companies Fail in Japan
            </h2>
          </FadeIn>
          <FadeIn delay={0.2}>
